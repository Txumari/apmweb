...
FOR %%x IN ("F:\Desarrollo\xampp\htdocs\apmweb/PEAR") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=F:\Desarrollo\xampp\htdocs\apmweb/PEAR"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=F:\Desarrollo\xampp\htdocs\apmweb"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=F:\Desarrollo\xampp\htdocs\apmweb\"
GOTO :INSTALLED
